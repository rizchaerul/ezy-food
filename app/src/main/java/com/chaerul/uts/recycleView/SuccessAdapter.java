...
public class SuccessAdapter extends RecyclerView.Adapter<SuccessAdapter.ViewHolder> {
    ...
    public SuccessAdapter(Context ctx, ArrayList<Item> items, ArrayList<Order> orders) {
        this.items = items;
        this.ctx = ctx;
        this.orders = orders;
    }
    ...
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(ctx).inflate(R.layout.success_list, parent, false);
